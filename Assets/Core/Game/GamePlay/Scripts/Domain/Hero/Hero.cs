...
public class Hero
{
    ...
    public Hero(string name, float health, float attack, float defense, float magic, string spriteAddress, Xp xp, int availableStatPoints, List<Move> availableMoves, List<Move> equippedMoves)
    {
        Name = name;
        Health = health;
        Attack = attack;
